 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_progfeedback_file_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_progfeedback_file_grade($data) {
        global $DB;
        ...
        $DB->insert_record('progfeedback_file', $data);

        $this->add_related_files('progfeedback_file', 'feedback_files', 'grade', null, $oldgradeid);
    }

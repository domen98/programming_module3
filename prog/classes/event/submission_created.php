...
/**
 * The mod_prog submission_created abstract event.
 *
 * @package    mod_prog
...
/**
 * The mod_prog submission_created abstract event class.
 *
...
abstract class submission_created extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissioncreated', 'mod_prog');
    }
    ...
    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['submissionid'] = array('db' => 'prog_submission', 'restore' => 'submission');

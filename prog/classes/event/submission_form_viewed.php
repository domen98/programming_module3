...
class submission_form_viewed extends base {
     ...
     */
    public static function create_from_user(\prog $prog, \stdClass $user) {
        $data = array(
    ...
    public static function get_name() {
        return get_string('eventsubmissionformviewed', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        if ($this->relateduserid == $this->userid) {
            ...
            $title = get_string('editsubmissionother', 'prog', fullname($user));
        }

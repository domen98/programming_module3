...
/**
 * The mod_prog identities revealed event.
 *
 * @package    mod_prog
...
/**
 * The mod_prog identities revealed event class.
 *
 * @package    mod_prog
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class identities_revealed extends base {
    ...
    public static function get_name() {
        return get_string('eventidentitiesrevealed', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('reveal identities', get_string('revealidentities', 'prog'));
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call identities_revealed::create() directly, use identities_revealed::create_from_prog() instead.');
        }

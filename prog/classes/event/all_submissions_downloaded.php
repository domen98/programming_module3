...
/**
 * The mod_prog all submissions downloaded event.
 *
 * @package    mod_prog
...
/**
 * The mod_prog all submissions downloaded event class.
 *
 * @package    mod_prog
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class all_submissions_downloaded extends base {
    ...
    public static function get_name() {
        return get_string('eventallsubmissionsdownloaded', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('download all submissions', get_string('downloadall', 'prog'));
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call all_submissions_downloaded::create() directly, use all_submissions_downloaded::create_from_prog() instead.');
        }

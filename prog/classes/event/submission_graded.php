...
/**
 * The mod_prog submission graded event.
 *
 * @package    mod_prog
...
/**
 * The mod_prog submission graded event class.
 *
 * @package    mod_prog
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_graded extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissiongraded', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        $grade = $this->get_record_snapshot('prog_grades', $this->objectid);
        $this->set_legacy_logdata('grade submission', $this->prog->format_grade_for_log($grade));

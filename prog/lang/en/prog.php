...
/**
 * Strings for component 'prog', language 'en'
 *
 * @package   mod_prog
...
$string['prog:addinstance'] = 'Add a new assignment';
$string['prog:exportownsubmission'] = 'Export own submission';
$string['prog:editothersubmission'] = 'Edit another student\'s submission';
$string['prog:grade'] = 'Grade assignment';
$string['prog:grantextension'] = 'Grant extension';
$string['prog:manageallocations'] = 'Manage markers allocated to submissions';
$string['prog:managegrades'] = 'Review and release grades';
$string['prog:receivegradernotifications'] = 'Receive grader submission notifications';
$string['prog:releasegrades'] = 'Release grades';
$string['prog:revealidentities'] = 'Reveal student identities';
$string['prog:reviewgrades'] = 'Review grades';
$string['prog:viewblinddetails'] = 'View student identities when blind marking is enabled';
$string['prog:viewgrades'] = 'View grades';
$string['prog:submit'] = 'Submit assignment';
$string['prog:view'] = 'View assignment';
$string['progfeedback'] = 'Feedback plugin';
$string['progfeedbackpluginname'] = 'Feedback plugin';
...
$string['manageprogfeedbackplugins'] = 'Manage assignment feedback plugins';
$string['manageprogsubmissionplugins'] = 'Manage assignment submission plugins';
...
$string['quickgrading_help'] = 'Quick grading allows you to prog grades (and outcomes) directly in the submissions table. Quick grading is not compatible with advanced grading and is not recommended when there are multiple markers.';
...
$string['subplugintype_progsubmission'] = 'Submission plugin';
$string['subplugintype_progsubmission_plural'] = 'Submission plugins';
$string['subplugintype_progfeedback'] = 'Feedback plugin';
$string['subplugintype_progfeedback_plural'] = 'Feedback plugins';

...
/**
 * The mod_prog submission locked event.
 *
 * @package    mod_prog
...
/**
 * The mod_prog submission locked event class.
 *
 * @package    mod_prog
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_locked extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionlocked', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('locksubmissionforstudent', 'prog', array('id' => $user->id, 'fullname' => fullname($user)));

...
/**
 * The mod_prog grading form viewed event.
 *
 * @package    mod_prog
...
/**
 * The mod_prog grading form viewed event class.
 *
...
class grading_form_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventgradingformviewed', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $msg = get_string('viewgradingformforstudent', 'prog',

...
/**
 * The mod_prog batch set marker allocation viewed event.
 *
 * @package    mod_prog
...
/**
 * The mod_prog batch set marker allocation viewed event class.
 *
...
class batch_set_marker_allocation_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventbatchsetmarkerallocationviewed', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewbatchmarkingallocation', 'prog');
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call batch_set_marker_allocation_viewed::create() directly, use batch_set_marker_allocation_viewed::create_from_prog() instead.');
        }

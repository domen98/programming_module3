...
/**
 * mod_prog workflow state updated event.
 *
 * @package    mod_prog
...
/**
 * mod_prog workflow state updated event class.
 *
...
class workflow_state_updated extends base {
     ...
     */
    public static function create_from_user(\prog $prog, \stdClass $user, $state) {
        $data = array(
    ...
    public static function get_name() {
        return get_string('eventworkflowstateupdated', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('setmarkingworkflowstateforlog', 'prog', $a);

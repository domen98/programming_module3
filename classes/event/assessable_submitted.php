...
/**
 * The mod_prog assessable submitted event.
 *
 * @package    mod_prog
...
/**
 * The mod_prog assessable submitted event class.
 *
...
class assessable_submitted extends base {
     ...
     */
    public static function create_from_submission(\prog $prog, \stdClass $submission, $editable) {
        global $USER;
    ...
    public static function get_name() {
        return get_string('eventassessablesubmitted', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $this->set_legacy_logdata('submit for grading', $this->prog->format_submission_for_log($submission));

...
/**
 * The mod_prog submission form viewed event.
 *
 * @package    mod_prog
...
/**
 * The mod_prog submission form viewed event class.
 *
...
class submission_confirmation_form_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionconfirmationformviewed', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewownsubmissionform', 'prog');
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call submission_confirmation_form_viewed::create() directly, use submission_confirmation_form_viewed::create_from_prog() instead.');
        }

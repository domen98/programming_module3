...
/**
 * The mod_prog submission duplicated event.
 *
 * @package    mod_prog
...
/**
 * The mod_prog submission duplicated event class.
 *
 * @package    mod_prog
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_duplicated extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionduplicated', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $this->set_legacy_logdata('submissioncopied', $this->prog->format_submission_for_log($submission));

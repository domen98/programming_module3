...
/**
 * The mod_prog marker updated event.
 *
 * @package    mod_prog
...
/**
 * The mod_prog marker updated event class.
 *
...
class marker_updated extends base {
     ...
     */
    public static function create_from_marker(\prog $prog, \stdClass $user, \stdClass $marker) {
        $data = array(
    ...
    public static function get_name() {
        return get_string('eventmarkerupdated', 'mod_prog');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('setmarkerallocationforlog', 'prog', $a);

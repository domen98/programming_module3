 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class progfeedback_offline_grade_importer {
     ...
     * @param prog $assignment The current assignment
     */
    public function __construct($importid, prog $assignment) {
    ...
    public function parsecsv($csvdata) {
        $this->csvreader = new csv_import_reader($this->importid, 'progfeedback_offline');
    ...
    public function init() {
        ...
        $strid = get_string('recordid', 'prog');
        $strmodified = get_string('lastmodifiedgrade', 'prog');
    ...
    public function next() {
        ...
        while ($record = $this->csvreader->next()) {
            ...
            $id = substr($idstr, strlen(get_string('hiddenuser', 'prog')));

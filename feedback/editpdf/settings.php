...
/**
 * Settings for progfeedback PDF plugin
 *
...
// Stamp files setting.
$name = 'progfeedback_editpdf/stamps';
$title = get_string('stamps','progfeedback_editpdf');
$description = get_string('stampsdesc', 'progfeedback_editpdf');
...
$settings->add(new admin_setting_heading('pathtogs', get_string('pathtogs', 'admin'),
        get_string('pathtogspathdesc', 'progfeedback_editpdf', $systempathlink)));

$url = new moodle_url('/mod/prog/feedback/editpdf/testgs.php');
$link = html_writer::link($url, get_string('testgs', 'progfeedback_editpdf'));

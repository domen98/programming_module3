YUI.add('moodle-progfeedback_editpdf-editor', function (Y, NAME) {
 ...
 *
 * @module moodle-progfeedback_editpdf-editor
 */
var AJAXBASE = M.cfg.wwwroot + '/mod/prog/feedback/editpdf/ajax.php',
    AJAXBASEPROGRESS = M.cfg.wwwroot + '/mod/prog/feedback/editpdf/ajax_progress.php',
    CSS = {
        DIALOGUE : 'progfeedback_editpdf_widget'
    },
    SELECTOR = {
        PREVIOUSBUTTON :  '.navigate-previous-button',
        NEXTBUTTON :  ' .navigate-next-button',
        SEARCHCOMMENTSBUTTON : '.searchcommentsbutton',
        SEARCHFILTER : '.progfeedback_editpdf_commentsearch input',
        SEARCHCOMMENTSLIST : '.progfeedback_editpdf_commentsearch ul',
        ...
        UNSAVEDCHANGESDIV : '.progfeedback_editpdf_unsavedchanges',
 ...
 *
 * @namespace M.progfeedback_editpdf
 * @param Number x
 * @param Number y
 * @class point
 */
var POINT = function(x, y) {
     ...
     * @method clip
     * @param M.progfeedback_editpdf.point
     * @public
     */
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.point = POINT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.rect = RECT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var EDIT = function() {
     ...
     * @property start
     * @type M.progfeedback_editpdf.point|false
     * @public
     */
    this.start = false;
     ...
     * @property path
     * @type M.progfeedback_editpdf.point[]
     * @public
     */
    this.path = [];
};
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.edit = EDIT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
 ...
 *
 * @namespace M.progfeedback_editpdf
 * @param M.progfeedback_editpdf.editor editor
 * @class drawable
 */
var DRAWABLE = function(editor) {

    /**
     * Reference to M.progfeedback_editpdf.editor.
     * @property editor
     * @type M.progfeedback_editpdf.editor
     * @public
     */
    this.editor = editor;
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.drawable = DRAWABLE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATION, Y.Base, {
    ...
    /**
     * Reference to M.progfeedback_editpdf.drawable
     * @property drawable
     * @type M.progfeedback_editpdf.drawable
     * @public
     */
    drawable : false,
     ...
     * @return M.progfeedback_editpdf.drawable
     */
    draw_highlight : function() {
        ...
        if (this.editor.currentannotation === this) {
            ...
            bounds = new M.progfeedback_editpdf.rect();
            bounds.bound([new M.progfeedback_editpdf.point(this.x, this.y),
                          new M.progfeedback_editpdf.point(this.endx, this.endy)]);
            ...
            var deleteicon = Y.Node.create('<img src="' + M.util.image_url('trash', 'progfeedback_editpdf') + '"/>'),
                deletelink = Y.Node.create('<a href="#" role="button"></a>');

            deleteicon.setAttrs({
                'alt': M.util.get_string('deleteannotation', 'progfeedback_editpdf')
            });
     ...
     * @public
     * @method draw
     * @return M.progfeedback_editpdf.drawable|false
     */
    draw : function() {
     ...
     * @param M.progfeedback_editpdf.edit edit
     */
    ...
    init_from_edit : function(edit) {
        var bounds = new M.progfeedback_editpdf.rect();
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.annotation = ANNOTATION;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
 ...
 * @extends M.progfeedback_editpdf.annotation
 */
...
Y.extend(ANNOTATIONLINE, M.progfeedback_editpdf.annotation, {
    /**
    ...
    draw : function() {
        ...
        drawable = new M.progfeedback_editpdf.drawable(this.editor);
     ...
     */
    draw_current_edit : function(edit) {
        var drawable = new M.progfeedback_editpdf.drawable(this.editor),
            shape;
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.annotationline = ANNOTATIONLINE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONRECTANGLE, M.progfeedback_editpdf.annotation, {
    /**
    ...
    draw_current_edit : function(edit) {
        ...
        bounds = new M.progfeedback_editpdf.rect();
        bounds.bound([new M.progfeedback_editpdf.point(edit.start.x, edit.start.y),
                      new M.progfeedback_editpdf.point(edit.end.x, edit.end.y)]);
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.annotationrectangle = ANNOTATIONRECTANGLE;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONOVAL, M.progfeedback_editpdf.annotation, {
    /**
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.annotationoval = ANNOTATIONOVAL;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONPEN, M.progfeedback_editpdf.annotation, {
    /**
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.annotationpen = ANNOTATIONPEN;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONHIGHLIGHT, M.progfeedback_editpdf.annotation, {
    /**
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.annotationhighlight = ANNOTATIONHIGHLIGHT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
Y.extend(ANNOTATIONSTAMP, M.progfeedback_editpdf.annotation, {
    /**
    ...
    draw : function() {
        ...
        position = this.editor.get_window_coordinates(new M.progfeedback_editpdf.point(this.x, this.y));
    ...
    draw_current_edit : function(edit) {
        ...
        bounds.bound([edit.start, edit.end]);
        position = this.editor.get_window_coordinates(new M.progfeedback_editpdf.point(bounds.x, bounds.y));
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.annotationstamp = ANNOTATIONSTAMP;
...
Y.extend(DROPDOWN, M.core.dialogue, {
    ...
    initializer : function(config) {
        ...
        bb.addClass('progfeedback_editpdf_dropdown');
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.dropdown = DROPDOWN;
 ...
 * @class colourpicker
 * @constructor
 * @extends M.progfeedback_editpdf.dropdown
 */
COLOURPICKER = function(config) {
    COLOURPICKER.superclass.constructor.apply(this, [config]);
};

Y.extend(COLOURPICKER, M.progfeedback_editpdf.dropdown, {
     ...
     */
    initializer : function(config) {
        var colourlist = Y.Node.create('<ul role="menu" class="progfeedback_editpdf_menu"/>'),
            body;
        ...
        Y.each(this.get('colours'), function(rgb, colour) {
            ...
            title = M.util.get_string(colour, 'progfeedback_editpdf');
            iconname = this.get('iconprefix') + colour;
            img = M.util.image_url(iconname, 'progfeedback_editpdf');
        ...
        this.set('headerText', M.util.get_string('colourpicker', 'progfeedback_editpdf'));
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.colourpicker = COLOURPICKER;
...
Y.extend(STAMPPICKER, M.progfeedback_editpdf.dropdown, {
     ...
     */
    initializer : function(config) {
        var stamplist = Y.Node.create('<ul role="menu" class="progfeedback_editpdf_menu"/>');

        // Build a list of stamped buttons.
        Y.each(this.get('stamps'), function(stamp) {
            var button, listitem, title;

            title = M.util.get_string('stamp', 'progfeedback_editpdf');
        ...
        // Set the accessible header text.
        this.set('headerText', M.util.get_string('stamppicker', 'progfeedback_editpdf'));
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.stamppicker = STAMPPICKER;
...
Y.extend(COMMENTMENU, M.progfeedback_editpdf.dropdown, {
    ...
    initializer : function(config) {
        ...
        commentlinks = Y.Node.create('<ul role="menu" class="progfeedback_editpdf_menu"/>');

        link = Y.Node.create('<li><a tabindex="-1" href="#">' +
               M.util.get_string('addtoquicklist', 'progfeedback_editpdf') +
               '</a></li>');
        ...
        link = Y.Node.create('<li><a tabindex="-1" href="#">' +
               M.util.get_string('deletecomment', 'progfeedback_editpdf') +
               '</a></li>');
        ...
        // Set the accessible header text.
        this.set('headerText', M.util.get_string('commentcontextmenu', 'progfeedback_editpdf'));
        ...
        Y.each(comment.editor.quicklist.comments, function(quickcomment) {
            var listitem = Y.Node.create('<li class="quicklist_comment"></li>'),
                ...
                deletelinkitem = Y.Node.create('<a href="#" tabindex="-1" class="delete_quicklist_comment">' +
                                               ...
                                               'alt="' + M.util.get_string('deletecomment', 'progfeedback_editpdf') + '"/>' +
                                               '</a>');
    ...
    ATTRS : {
         ...
         *
         * @attribute comment
         * @type M.progfeedback_editpdf.comment
         * @default null
         */
        comment : {
            value : null
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.commentmenu = COMMENTMENU;
...
COMMENTSEARCH = function(config) {
    ...
    config.width = '400px';
    config.visible = false;
    config.headerContent = M.util.get_string('searchcomments', 'progfeedback_editpdf');
    config.footerContent = '';
...
Y.extend(COMMENTSEARCH, M.core.dialogue, {
    ...
    initializer : function(config) {
        ...
        bb = this.get('boundingBox');
        bb.addClass('progfeedback_editpdf_commentsearch');

        editor = this.get('editor');
        container = Y.Node.create('<div/>');

        placeholder = M.util.get_string('filter', 'progfeedback_editpdf');
        commentfilter = Y.Node.create('<input type="text" size="20" placeholder="' + placeholder + '"/>');
        container.append(commentfilter);
        commentlist = Y.Node.create('<ul role="menu" class="progfeedback_editpdf_menu"/>');
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.commentsearch = COMMENTSEARCH;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var COMMENT = function(editor, gradeid, pageno, x, y, width, colour, rawtext) {
     ...
     * @property menu
     * @type M.progfeedback_editpdf.dropdown
     * @public
     */
    this.menu = null;
    ...
    this.attach_events = function(node, menu) {
        ...
        node.on('gesturemove', function(e) {
            ...
            newlocation = this.editor.get_canvas_coordinates(new M.progfeedback_editpdf.point(x, y));
        ...
        this.menu = new M.progfeedback_editpdf.commentmenu({
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.comment = COMMENT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.quickcomment = QUICKCOMMENT;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
var QUICKCOMMENTLIST = function(editor) {
     ...
     * Array of Comments
     * @property shapes
     * @type M.progfeedback_editpdf.quickcomment[]
     * @public
     */
    this.comments = [];
                ...
                success: function(tid, response) {
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            quickcomment = new M.progfeedback_editpdf.quickcomment(jsondata.id,
                                                                                     jsondata.rawtext,
                                                                                     jsondata.width,
                                                                                     jsondata.colour);
                    ...
                    try {
                        ...
                        if (jsondata.error) {
                            ...
                            Y.each(jsondata, function(comment) {
                                var quickcomment = new M.progfeedback_editpdf.quickcomment(comment.id,
                                                                                             comment.rawtext,
                                                                                             comment.width,
                                                                                             comment.colour);
                                this.comments.push(quickcomment);
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.quickcommentlist = QUICKCOMMENTLIST;
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
...
EDITOR.prototype = {
     ...
     * @type M.progfeedback_editpdf.edit
     * @protected
     */
    currentedit : new M.progfeedback_editpdf.edit(),

    /**
     * Current drawable.
     *
     * @property currentdrawable
     * @type M.progfeedback_editpdf.drawable|false
     * @protected
     */
     ...
     *
     * @property drawables
     * @type array(M.progfeedback_editpdf.drawable)
     * @protected
     */
    drawables : [],
     ...
     * @type M.progfeedback_editpdf.annotation
     * @protected
     */
     ...
     * @property quicklist
     * @type M.progfeedback_editpdf.quickcommentlist
     * @protected
     */
    quicklist : null,
    ...
    initializer : function() {
        ...
        if (link) {
            ...
            if (!this.get('readonly')) {
                this.quicklist = new M.progfeedback_editpdf.quickcommentlist(this);
            }
        }
    },
    ...
    refresh_button_state : function() {
        ...
        imgurl = M.util.image_url('background_colour_' + this.currentedit.commentcolour, 'progfeedback_editpdf');
        ...
        imgurl = M.util.image_url('colour_' + this.currentedit.annotationcolour, 'progfeedback_editpdf');
        button.one('img').setAttribute('src', imgurl);

        currenttoolnode = this.get_dialogue_element(TOOLSELECTOR[this.currentedit.tool]);
        currenttoolnode.addClass('progfeedback_editpdf_selectedbutton');
    ...
    get_canvas_bounds : function() {
        ...
        return new M.progfeedback_editpdf.rect(offsetleft, offsettop, width, height);
    },

    /**
     * Called to translate from window coordinates to canvas coordinates.
     * @method get_canvas_coordinates
     * @param M.progfeedback_editpdf.point point in window coordinats.
     */
    get_canvas_coordinates : function(point) {
        var bounds = this.get_canvas_bounds(),
            newpoint = new M.progfeedback_editpdf.point(point.x - bounds.x, point.y - bounds.y);
    ...
    all_pages_loaded : function(responsetext) {
        ...
        try {
            ...
            if (data.error || !data.pagecount) {
                ...
                error = new M.core.alert({ message: M.util.get_string('cannotopenpdf', 'progfeedback_editpdf') });
                error.show();
                return;
            }
        } catch (e) {
            this.dialogue.hide();
            // Display alert dialogue.
            error = new M.core.alert({ title: M.util.get_string('cannotopenpdf', 'progfeedback_editpdf')});
            error.show();
            return;
        }
        ...
        for (i = 0; i < this.pages.length; i++) {
            for (j = 0; j < this.pages[i].comments.length; j++) {
                ...
                this.pages[i].comments[j] = new M.progfeedback_editpdf.comment(this,
                                                                                 comment.gradeid,
                                                                                 comment.pageno,
                                                                                 comment.x,
                                                                                 comment.y,
    ...
    setup_toolbar : function() {
        ...
        picker = new M.progfeedback_editpdf.colourpicker({
        ...
        if (stampfiles.length <= 0) {
            ...
            picker = new M.progfeedback_editpdf.stamppicker({
    ...
    handle_tool_button : function(e, tool) {
        ...
        currenttoolnode = this.get_dialogue_element(TOOLSELECTOR[this.currentedit.tool]);
        currenttoolnode.removeClass('progfeedback_editpdf_selectedbutton');
    ...
    get_current_drawable : function() {
        ...
        if (this.currentedit.tool === 'comment') {
            comment = new M.progfeedback_editpdf.comment(this);
    ...
    edit_move : function(e) {
        ...
        var bounds = this.get_canvas_bounds(),
            ...
            clientpoint = new M.progfeedback_editpdf.point(e.clientX + canvas.get('docScrollX'),
    ...
    create_annotation : function(type, data) {
        ...
        data.editor = this;
        if (type === "line") {
            return new M.progfeedback_editpdf.annotationline(data);
        } else if (type === "rectangle") {
            return new M.progfeedback_editpdf.annotationrectangle(data);
        } else if (type === "oval") {
            return new M.progfeedback_editpdf.annotationoval(data);
        } else if (type === "pen") {
            return new M.progfeedback_editpdf.annotationpen(data);
        } else if (type === "highlight") {
            return new M.progfeedback_editpdf.annotationhighlight(data);
        } else if (type === "stamp") {
            return new M.progfeedback_editpdf.annotationstamp(data);
        }
        return false;
    },
    ...
    open_search_comments : function(e) {
        if (!this.searchcommentswindow) {
            this.searchcommentswindow = new M.progfeedback_editpdf.commentsearch({
                editor : this
            });
        }
    ...
    setup_navigation : function() {
        ...
        if (options.size() <= 1) {
            for (i = 0; i < this.pages.length; i++) {
                ...
                option.setHTML(M.util.get_string('pagenumber', 'progfeedback_editpdf', i+1));
...
Y.extend(EDITOR, Y.Base, EDITOR.prototype, {
    NAME : 'moodle-progfeedback_editpdf-editor',
    ATTRS : {
        userid : {
...
M.progfeedback_editpdf = M.progfeedback_editpdf || {};
M.progfeedback_editpdf.editor = M.progfeedback_editpdf.editor || {};
 ...
 * @param {Object} params
 */
M.progfeedback_editpdf.editor.init = M.progfeedback_editpdf.editor.init || function(params) {

...
require_once($CFG->dirroot . '/mod/prog/assignmentplugin.php');
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class prog_submission_plugin extends prog_plugin {
     ...
     * @param stdClass $submission the prog_submission record being submitted.
     ...
     *
     * @param stdClass|false $submission - prog_submission data if any
     ...
     *
     * @param stdClass $submission - prog_submission data
     * @return void
     */

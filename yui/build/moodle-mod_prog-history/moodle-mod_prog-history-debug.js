YUI.add('moodle-mod_prog-history', function (Y, NAME) {

// Define a function that will run in the context of a
// Node instance:
var CSS = {
        LINK: 'mod-prog-history-link',
        OPEN: 'mod-prog-history-link-open',
        CLOSED: 'mod-prog-history-link-closed',
        PANEL: 'mod-prog-history-panel'
    },
    COUNT = 0,
    TOGGLE = function() {
        var id = this.get('for'),
